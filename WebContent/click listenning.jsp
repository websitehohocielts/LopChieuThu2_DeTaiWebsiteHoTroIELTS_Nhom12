...
<li><a href="#">IELTS 6.0</a></li>
    ...
    <div class="container">
      ...
      <div class="row">
       ...
       <hr>
       <div class="row">
        <img id="anh2" src="images/Desert.jpg" align="left" width="100" height="100" class="img-circle"/>
        <a id="bai2" href="#">Unit 21: Kỹ năng nghe loại câu hỏi xác định người (People Identifying) - Phần Short Conversation  </a><br>
      </div>
       <hr>
       <div class="row">
        <img id="anh3" src="images/Desert.jpg" align="left" width="100" height="100" class="img-circle"/>
    ...
    <script type="text/javascript">
      ...
      function laydanhsach(trang){
        ...
        xhr.open("GET","clickListening.json","true");
        xhr.send();
